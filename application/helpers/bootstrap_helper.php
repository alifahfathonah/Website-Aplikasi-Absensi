...
if ( ! function_exists( 'fa' ) ) {
	 ...
	 *
	 **/
	function fa( $icon_class = 'home', $string = null )
	{
		return '<i class="fa fa-'.$icon_class.'"></i> ' .$string;
	}
...
if ( ! function_exists( 'progress_bar' ) ) {
	 ...
	 * @author 
	 **/
	function progress_bar( $min = 0, $max = 0)
	{
		return 	'<progress class="progress progress-striped progress-success" value="'.$min.'" max="'.$max.'"></progress>';
	}
